...
apie    	     db 'asm to html highlighter',13,10,9,'asm4html.exe [/?] sourceFile destinationFile',13,10,9,'asm4html.exe [/?] destinationFile',13,10,9,'/? - pagalba',13,10,'$'
...
lea di, tempF
call read_filename
cmp	byte ptr es:[tempF], '$' ; ar tik vienas failas
jne _01
